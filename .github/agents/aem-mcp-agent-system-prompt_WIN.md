...
### 3.6 SKILL — Recepción de Tareas (Orchestrator Integration)

> **Cuándo activar:** Cuando el input provenga del Agente Orquestador o contenga un archivo aem_task_bundle.json.
